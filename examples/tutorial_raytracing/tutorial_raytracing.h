...
public:
	...
	*/
	void createRayTracingPipeline()
	{
      ...
      {
         {getShadersPath() + "tutorial_raytracing/raygen.rgen.spv", genesis::ST_RAYGEN}
       , {getShadersPath() + "tutorial_raytracing/miss.rmiss.spv", genesis::ST_MISS}
		 , {getShadersPath() + "tutorial_raytracing/closesthit.rchit.spv", genesis::ST_CLOSEST_HIT}
      };
